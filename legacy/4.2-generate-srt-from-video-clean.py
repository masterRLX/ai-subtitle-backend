...
def generate_srt_from_video(input_video_path, subtitle_dir):
    ...
    ## 1. 영상 -> segments ###########################################
    print('\n\n1. 오디오 -> whisper로 텍스트 변환(segments 포함)')
    ...
    return subtitle_srt_path ## 위쪽 함수의 있는 리턴

# def generate_srt_from_video(input_video_path, output_audio_path, subtitle_srt_path):
